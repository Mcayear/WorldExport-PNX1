...
public class WorldExportCommand extends PluginCommand<WorldExportPlugin> {

    public WorldExportCommand() {
        /*
        ...
        */
        super("worldexport", "exampleplugin.examplecommand.description", WorldExportPlugin.INSTANCE);
